...
- Automate scans with timers or discovery mode: see [Scanning modes & scheduling](scanning-modes.md) and [OmniTrust & CBOM-Repository integration](integration-ilm.md).
