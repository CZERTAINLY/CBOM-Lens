...
It is designed to be used both as a standalone scanner and as part of the OmniTrust platform.
...
- Integrating with **OmniTrust Core** to support automated cryptographic asset management.
...
- **Discovery** – run as a service managed by OmniTrust via a discovery protocol.
...
- Expose an HTTP server and integrate with **OmniTrust Core** in discovery mode.
...
- [OmniTrust & CBOM-Repository integration](integration-ilm.md).
