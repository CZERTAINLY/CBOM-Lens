...
- [ ] **Step 2: Build and run the bom package tests — expect exactly one failure**
...
- [ ] **Step 4: Verify everything is green, including byte-identical golden**
...
- [ ] **Step 3: Vendor the two schema files, verifying pins** (requires network; if offline, stop — no valid local source exists: cyclonedx-go's bundled bom-1.7 is an older snapshot)
...
- [ ] **Step 4: Add the schemaSets entry**
...
- [ ] **Step 4: Run tests to verify green + golden untouched**
...
- [ ] **Step 1: Extract the shared dependsOn regroup helper (pure refactor)**
...
- [ ] **Step 2: Write the failing emit17 tests**
...
- [ ] **Step 2: Run to verify red, inspect, then capture**
...
- [ ] **Step 3: Run the full package to verify green + determinism**
