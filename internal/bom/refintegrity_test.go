...
func TestCycloneDXRefFieldInventory(t *testing.T) {
	expected := []string{
		...
		"def Citation.BOMRef json=bom-ref string",
		...
		"def LicenseChoice.BOMRef json=bom-ref string",
		"def LicenseExpressionDetail.BOMRef json=bom-ref string",
		...
		"def Patent.BOMRef json=bom-ref string",
		"def PatentAssertion.BOMRef json=bom-ref string",
		"def PatentFamily.BOMRef json=bom-ref string",
		...
		"use AsserterChoice.BOMRef json=ref *cyclonedx.BOMReference",
		...
		"use Citation.AttributedTo json=attributedTo *cyclonedx.BOMReference",
		...
		"use IKEv2Auth.BOMRef json=BOMRef cyclonedx.BOMReference",
		"use IKEv2Enc.BOMRef json=BOMRef cyclonedx.BOMReference",
		"use IKEv2Integ.BOMRef json=BOMRef cyclonedx.BOMReference",
		"use IKEv2Ke.BOMRef json=BOMRef cyclonedx.BOMReference",
		"use IKEv2Prf.BOMRef json=BOMRef cyclonedx.BOMReference",
		"use MLDatasetChoice.Ref json=Ref string",
		"use PatentAssertion.PatentRefs json=patentRefs *[]cyclonedx.BOMReference",
		"use PatentFamily.Members json=members *[]cyclonedx.BOMReference",
		"use RelatedCryptoMaterialProperties.AlgorithmRef json=algorithmRef cyclonedx.BOMReference",
		"use RelatedCryptographicAsset.Ref json=ref string",
