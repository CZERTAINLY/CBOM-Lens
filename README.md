...
- **Flexible operation modes**
  ...
  - **Discovery** mode managed by OmniTrust Core.
- **Integration-ready**
...
- **OmniTrust-managed discovery** – `service.mode: discovery` with additional `service.server` and `service.core` configuration.
...
- `discovery` – CBOM-Lens runs as a service managed by OmniTrust via the discovery protocol.
...
- [OmniTrust & CBOM-Repository integration](docs/integration-ilm.md).
